...
[![NAC v2.0.0-rc3](https://img.shields.io/badge/NAC-v2.0.0--rc3-violet.svg)](spec/NAC-v2.0.md)
...
**License:** MIT.
**Spec version:** v2.0.0-rc3 (2026-05-09) -- closes 1 BLOCKER
                  (Claude gesture-buffer leak) + 8 conditions
                  from Round 3 peer review (4 reviewers complete).
                  v1.9.0 stable (2026-05-08, tag `v1.9.0`).
**Reference runtime:** v1.9.0 (`NAC.version === '1.9.0'`) + v2.0 extensions
  (`NAC.version_v2 === '2.0.0-rc3'` after `js/nac-v2-extensions.js` is loaded).
