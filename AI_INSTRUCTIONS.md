...
2026-05-06. NAC spec version: 1.5 / runtime 1.5.4 (strict
superset of 1.4, 1.3, 1.2, 1.1, 1.0). v1.4.1 + v1.4.2 are
...
exhaustive 10-locale i18n sweep on the reference demo. The
attribute / event / driver-API vocabulary in this file is
stable across all 1.x versions; the only adds since v1.0 are
new role tokens, new event names, and new driver functions
(documented per-version in `docs/API_REFERENCE.md`).
